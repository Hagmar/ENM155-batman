...
ca 90\% fram till 2020 \cite{mckinsey}. Dessutom har man hos vätgasbilar en
räckvidd\footnote{Ca 500 km enligt regeringens rapport\cite{fossilfrihet}.} som är lik den man finner hos bilar
...
\lstinputlisting[]{../code/scenario1alt1.json}  

Här är inputdatan från scenario 1 alternativ 1:
\lstinputlisting[]{../code/scenario1alt2.json}  

Här är inputdatan från scenario 1 alternativ 1:
\lstinputlisting[]{../code/scenario2.json}  
\end{document}
